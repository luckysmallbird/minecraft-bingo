...
execute if score tick stage matches 10 run function flytre:detect/base
...
execute as @a[scores={give_map=1..},gamemode=!spectator] run give @s filled_map{map:1,display:{Name:'{"text":"Bingo Board","color":"dark_red","italic":false}',Lore:['{"text":"Drop me to update the board!","color":"gray","italic":false}']}} 8
...
execute if score tools stage matches 1 unless score keepInventory stage matches 1 unless score lockout stage matches 2 run give @a[scores={death=1}] minecraft:stone_axe{start:1}
...
execute if score tools stage matches 1 unless score keepInventory stage matches 1 unless score item_set stage matches 2 run give @a[scores={death=1}] minecraft:stone_pickaxe{start:1}
...
execute if score tools stage matches 1 unless score keepInventory stage matches 1 run give @a[scores={death=1}] minecraft:stone_shovel{start:1}

execute unless score keepInventory stage matches 1 as @a[scores={death=1}] run give @s filled_map{start:1,map:1,display:{Name:'{"text":"Bingo Board","color":"dark_red","italic":false}',Lore:['{"text":"Drop me to update the board!","color":"gray","italic":false}']}} 32
execute unless score keepInventory stage matches 1 if score lockout stage matches 2 run loot replace entity @a[scores={death=1}] hotbar.8 1 mine 0 5 0 minecraft:air{drop_contents: 1b}
...
execute if score lockout stage matches 2 unless score sec stage matches 0 if score sec stage matches 10.. run title @a[team=red] actionbar ["",{"text":"Released: ","color":"dark_aqua"},{"score":{"name":"min","objective":"stage"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"sec","objective":"stage"},"color":"gold"}]
execute if score lockout stage matches 2 unless score sec stage matches 0 unless score sec stage matches 10.. run title @a[team=red] actionbar ["",{"text":"Released: ","color":"dark_aqua"},{"score":{"name":"min","objective":"stage"},"color":"gold"},{"text":":0","color":"gold"},{"score":{"name":"sec","objective":"stage"},"color":"gold"}]
