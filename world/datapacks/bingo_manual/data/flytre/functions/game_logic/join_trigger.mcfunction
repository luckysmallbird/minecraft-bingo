...
execute if score tools stage matches 1 run item replace entity @s[team=!] hotbar.1 with minecraft:stone_axe{start:1}
execute if score tools stage matches 1 unless score item_set stage matches 2 run item replace entity @s[team=!] hotbar.2 with minecraft:stone_pickaxe{start:1}
...
execute if score tools stage matches 1 run item replace entity @s[team=!] hotbar.3 with minecraft:stone_shovel{start:1}
execute if score lockout stage matches 2 run item replace entity @s[team=!] hotbar.8 from block 0 5 0 container.0
item replace entity @s[team=!] weapon.offhand with filled_map{start:1,map:1,display:{Name:'{"text":"Bingo Board","color":"dark_red","italic":false}',Lore:['{"text":"Drop me to update the board!","color":"gray","italic":false}']}} 32
