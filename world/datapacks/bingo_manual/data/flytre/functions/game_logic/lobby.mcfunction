...
execute as @a[tag=!init] run give @s filled_map{map:1,display:{Name:'{"text":"Bingo Board","color":"dark_red","italic":false}'}} 1
execute as @a[tag=!init] run tp @s 182.5 135 81.0 -90 0
tag @a add init


#team join by stepping on concrete
execute as @a[team=!red] at @s if block ~ ~-1 ~ red_concrete run tellraw @s ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":":","color":"none"},{"text":" You have joined the ","color":"none"},{"text":"Red Team","color":"red"},{"text":"!","color":"none"}]
execute as @a[team=!red] at @s if block ~ ~-1 ~ red_concrete run tellraw @a[distance=1..] ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":": ","color":"none"},{"selector":"@s"},{"text":" has joined the ","color":"none"},{"text":"Red Team","color":"red"},{"text":"!","color":"none"}]
...
execute as @a[team=!yellow] at @s if block ~ ~-1 ~ yellow_concrete run tellraw @s ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":":","color":"none"},{"text":" You have joined the ","color":"none"},{"text":"Yellow Team","color":"yellow"},{"text":"!","color":"none"}]
execute as @a[team=!yellow] at @s if block ~ ~-1 ~ yellow_concrete run tellraw @a[distance=1..] ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":": ","color":"none"},{"selector":"@s"},{"text":" has joined the ","color":"none"},{"text":"Yellow Team","color":"yellow"},{"text":"!","color":"none"}]
...
execute as @a[team=!green] at @s if block ~ ~-1 ~ lime_concrete run tellraw @s ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":":","color":"none"},{"text":" You have joined the ","color":"none"},{"text":"Green Team","color":"green"},{"text":"!","color":"none"}]
execute as @a[team=!green] at @s if block ~ ~-1 ~ lime_concrete run tellraw @a[distance=1..] ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":": ","color":"none"},{"selector":"@s"},{"text":" has joined the ","color":"none"},{"text":"Green Team","color":"green"},{"text":"!","color":"none"}]
...
execute as @a[team=!blue] at @s if block ~ ~-1 ~ cyan_concrete run tellraw @s ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":":","color":"none"},{"text":" You have joined the ","color":"none"},{"text":"Blue Team","color":"blue"},{"text":"!","color":"none"}]
execute as @a[team=!blue] at @s if block ~ ~-1 ~ cyan_concrete run tellraw @a[distance=1..] ["",{"text":"[","color":"green"},{"text":"Team","color":"none"},{"text":"]","color":"green"},{"text":": ","color":"none"},{"selector":"@s"},{"text":" has joined the ","color":"none"},{"text":"Blue Team","color":"blue"},{"text":"!","color":"none"}]
...
execute if block 209 136 83 minecraft:lever[powered=true] if score start_timer stage matches 1 run tellraw @a ["",{"text":"[","color":"dark_green"},{"text":"Game","color":"green","bold":true},{"text":"]:","color":"dark_green","bold":false},{"text":" Game starting in 5 seconds. Flick the lever to stop.","color":"green"}]
