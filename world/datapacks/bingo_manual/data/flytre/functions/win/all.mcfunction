...
execute if score lockout stage matches 0 if score sec stage matches 10.. run tellraw @a ["Time: ",{"score":{"name":"min","objective":"stage"},"color":"gold"},{"text":":","color":"gold"},{"score":{"name":"sec","objective":"stage"},"color":"gold"}]
execute if score lockout stage matches 0 unless score sec stage matches 10.. run tellraw @a ["Time: ",{"score":{"name":"min","objective":"stage"},"color":"gold"},{"text":":0","color":"gold"},{"score":{"name":"sec","objective":"stage"},"color":"gold"}]
