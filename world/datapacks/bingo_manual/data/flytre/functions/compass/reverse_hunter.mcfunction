...
execute unless entity @a[tag=compass_closest] run title @a[tag=compass_hunter,nbt={SelectedItem:{id:"minecraft:compass"}}] actionbar ["",{"text":"Nearest Hunter: ","color":"white"},{"text":"N/A","color":"red"}]
